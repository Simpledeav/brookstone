            ...
            <ul class="header-content-right">
                ...
                <li class="header-element notifications-dropdown d-xl-block d-none dropdown">
                    ...
                    <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-toggle="dropdown"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="header-link-icon animate-bell" height="35px"
                    ...
                    <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                        <div class="p-3">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <span class="badge bg-primary-transparent" id="notifiation-data">{{auth()->user()->unreadNotifications()->count()}} Unread</span>
                            </div>
                        </div>
                                    ...
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-start">
                                            <div class="pe-2 lh-1">
                                                ...
                                                <img src="https://www.iconpacks.net/icons/1/free-bell-icon-860-thumb.png">
                                                </span>
                                            </div>
                                            <div class="flex-grow-1 d-flex align-items-start justify-content-between">
                                                <div>
                                                    <p class="mb-0 fw-medium"><a href="javascript:void(0);">{{ $notification['data']['title'] }}<span class="text-muted fs-11 ms-2">{{ $notification['created_at']->diffForHumans() }}</span></a></p>
